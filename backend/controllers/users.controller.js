...
export const createUser = async (req, res) => {
  ...
  try {
    ...
    const [result] = await pool.query('INSERT INTO users (username, email, password, role_id) VALUES (?, ?, ?, ?)', [username, email, hashedPassword, role_id])
...
export const getUsers = async (req, res) => {
  try {
    ...
    const [totalRows] = await pool.query('SELECT COUNT(*) as total FROM users WHERE is_active = TRUE')
