        ...
        <ul v-if="authStore.isAuthenticated" class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown" :class="{ show: workDropdownOpen }">
            ...
            <ul class="dropdown-menu" :class="{ show: workDropdownOpen }">
              ...
              <li>
                <RouterLink class="dropdown-item" to="/my-work-orders" @click="closeAllDropdowns">Mis Órdenes</RouterLink>
              </li>
            </ul>
          </li>
          ...
          <li v-if="authStore.isAdmin" class="nav-item dropdown" :class="{ show: adminDropdownOpen }">
            ...
            <ul class="dropdown-menu" :class="{ show: adminDropdownOpen }">
              ...
              <li>
                <RouterLink class="dropdown-item" to="/work-orders" @click="closeAllDropdowns">Órdenes de Trabajo</RouterLink>
              </li>
              <li><hr class="dropdown-divider" /></li>
              <li>
                <RouterLink class="dropdown-item" to="/inventory/adjustments" @click="closeAllDropdowns">Ajustes de Inventario</RouterLink>
              </li>
              <li>
                <RouterLink class="dropdown-item" to="/inventory/movements" @click="closeAllDropdowns">Historial de Movimientos</RouterLink>
              </li>
            </ul>
          </li>
        </ul>
