          ...
          <RouterLink to="/categories" class="card-link-wrapper">
            <div class="card text-center shadow-sm h-100">
              <div class="card-body d-flex flex-column justify-content-center align-items-center">
                ...
                <p class="card-text text-muted flex-grow-1">Crear, editar y organizar las categorías de los productos.
                </p>
          ...
          <RouterLink to="/products" class="card-link-wrapper">
            <div class="card text-center shadow-sm h-100">
              <div class="card-body d-flex flex-column justify-content-center align-items-center">
                ...
                <p class="card-text text-muted flex-grow-1">Ver, agregar, editar y eliminar productos del inventario.
                </p>
          ...
          <RouterLink to="/users" class="card-link-wrapper">
            <div class="card text-center shadow-sm h-100">
              <div class="card-body d-flex flex-column justify-content-center align-items-center">
                ...
                <p class="card-text text-muted flex-grow-1">Gestionar las cuentas y los roles de los usuarios del
                  sistema.</p>
          ...
          <RouterLink to="/work-orders" class="card-link-wrapper">
            <div class="card text-center shadow-sm h-100">
              <div class="card-body d-flex flex-column justify-content-center align-items-center">
                ...
                <p class="card-text text-muted flex-grow-1">Crear, asignar y dar seguimiento a las órdenes de trabajo.
                </p>
