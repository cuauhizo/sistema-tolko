...
<template>
  <li class="nav-item me-2 dropdown">
    <a class="nav-link py-0 pt-1" href="#" id="notificationDropdown" role="button" data-bs-toggle="dropdown"
      aria-expanded="false">
...
.dropdown-item {
  white-space: normal;
  /* Permite que el texto de la notificación ocupe varias líneas */
  cursor: pointer;
}
