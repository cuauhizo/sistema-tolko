                  ...
                  <div class="d-flex flex-wrap gap-3 w-100 justify-content-between">
                    <div class="btn-group btn-group-sm" role="group">
                      <button
                        ...
                        class="btn"
                        :class="
                          item.status === 'pendiente' ? 'btn-warning' : 'btn-outline-secondary'
                        "
                      ...
                      <button
                        ...
                        class="btn"
                        :class="
                          item.status === 'en_progreso' ? 'btn-info' : 'btn-outline-secondary'
                        "
                      ...
                      <button
                        ...
                        class="btn"
                        :class="
                          item.status === 'completada' ? 'btn-success' : 'btn-outline-secondary'
                        "
                ...
                <div class="card-body">
                  ...
                  <div class="btn-group btn-group-sm" role="group">
                    <button
                      type="button"
                      class="btn"
                      :class="item.status === 'pendiente' ? 'btn-warning' : 'btn-outline-secondary'"
                      @click="handleStatusChange(item, 'pendiente')"
                    >
                      Pendiente
                    </button>
                    <button
                      type="button"
                      class="btn"
                      :class="item.status === 'en_progreso' ? 'btn-info' : 'btn-outline-secondary'"
                      @click="handleStatusChange(item, 'en_progreso')"
                    >
                      En Progreso
                    </button>
