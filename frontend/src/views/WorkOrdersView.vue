...
const handleFormSubmit = async (orderData) => {
  ...
  // Le decimos al formulario que se cierre después de guardar.
...
<template>
  <div class="container my-4">
    ...
    <WorkOrderForm ref="orderFormRef" :order-to-edit="orderToEdit" @submit="handleFormSubmit" />
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p v-if="orderToDelete">
              ¿Estás seguro de que deseas eliminar la orden: <strong>{{ orderToDelete.title }}</strong>?
            </p>
