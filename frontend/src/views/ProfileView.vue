  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
      <h1 class="text-2xl font-bold text-gray-800 flex items-center">
        <i class="pi pi-user !text-3xl mr-3 text-blue-600"></i>
        Mi Perfil
      </h1>
      <p class="text-gray-500 mt-1 text-sm sm:text-base">Administra tu información personal y la seguridad de tu cuenta.</p>
    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
          ...
          <div class="border-t border-gray-100 pt-4 mt-2 text-left space-y-3">
            ...
            <div class="flex items-center text-sm">
              ...
              <span class="text-gray-600">Miembro desde {{ authStore.memberSince }}</span>
            </div>
          </div>
        </div>
